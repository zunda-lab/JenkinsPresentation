...
- @size[0.5em](QCDのQ：品質を達成できない４つの阻害要因)
- @size[0.5em](QCDのC：コストを達成できない４つの阻害要因)
- @size[0.5em](QCDのD：納期を達成できない３つの阻害要因)
- @size[0.5em](短期での機能追加・改善ができない４つの阻害要因)
- @size[0.5em](〔まとめ〕なぜ短期開発やQCDが達成できないのか)
@olend
