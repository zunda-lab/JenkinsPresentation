...
@size[0.39em](※阻害要因「No.6 手順の属人化」「No.15 創造的な作業に集中できない」は、)
@size[0.39em](JenkinsによるCIを導入すること自体で解消される。)
...
+++?image=assets/images/coverage_report.png&position=bottom 5% left 50%&size=auto 40%
@ul[list-style-type-none]
- ■ カバレッジ測定の結果レポートが自動作成
- ⇒ 阻害要因「報告書作成」が解消
@ulend
